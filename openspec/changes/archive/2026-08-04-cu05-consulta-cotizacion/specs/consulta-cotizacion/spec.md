# Spec: consulta-cotizacion

## Purpose

Permitir a los clientes iniciar conversaciones con vendedores sobre vehículos
específicos, gestionar el intercambio de mensajes y notificar sobre actividad
nueva. Incluye la bandeja de entrada del vendedor y la vista de chat del cliente.
