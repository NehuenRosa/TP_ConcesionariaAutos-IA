...
func (h *ChatbotHandler) Responder(c *gin.Context) {
	...
	respuesta, err := h.servicio.Responder(c.Request.Context(), peticion.Mensaje, peticion.Historial)
	if err != nil {
...
// estimación del valor de permuta en lenguaje natural.
func (h *ChatbotHandler) Tasacion(c *gin.Context) {
	...
	respuesta, err := h.servicio.Tasacion(c.Request.Context(), descripcion, imagenes)
	if err != nil {
