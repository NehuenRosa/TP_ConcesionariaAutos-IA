...
func AutoMigrar(base *gorm.DB) error {
	if err := base.AutoMigrate(&models.Vehiculo{}, &models.Imagen{}, &models.Usuario{}, &models.Consulta{}, &models.Mensaje{}, &models.TurnoTestDrive{}, &models.Reserva{}, &models.ComprobanteReserva{}, &models.Tasacion{}, &models.Cotizacion{}, &models.MensajeCotizacion{}); err != nil {
