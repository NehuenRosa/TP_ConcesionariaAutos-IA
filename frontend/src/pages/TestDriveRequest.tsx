      ...
      <div className="w-full max-w-lg animate-slide-up">
        ...
        {success ? (
          <div className="card p-8 text-center">
            ...
            <p className="text-gray-500">Esperá la confirmación del vendedor. Redirigiendo al catálogo...</p>
          </div>
        ) : (
          <div className="card p-8">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-900">Solicitar Test Drive</h1>
                <p className="text-sm text-gray-500">Agendá una prueba de manejo</p>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1.5">Fecha y hora del test drive</label>
                <input
                  type="datetime-local"
                  value={scheduledAt}
